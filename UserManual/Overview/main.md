...
Click on the 'Import from LotRO' button. This will open the window 'Import from local client'.
...
### Manual character creation
Click on the 'New' button in the toolbar. This will open the character creation dialog.
...
### Levels
Click on the 'levels' icon in the toolbar of the main window. This will open the 'levelling synopsis' window.
...
### Crafting
Click on the 'crafting' icon in the toolbar of the main window. This will open the 'crafting synopsis' window.
Choose the characters you want to show.
The table will show the current status of all the chosen characters in all their professions.

### Reputation
Click on the 'reputation' icon in the toolbar of the main window. This will open the 'reputation synopsis' window.
Choose the characters you want to show.
...
### Items explorer
Click on the 'chest' icon in the toolbar of the main window. This will open the 'items explorer' window.
...
### Deeds explorer
Click on the 'deed' icon in the toolbar of the main window. This will open the 'deeds explorer' window.
...
### Quests explorer
Click on the 'ring' icon in the toolbar of the main window. This will open the 'quests explorer' window.
...
### Recipes explorer
Click on the 'recipes book' icon in the toolbar of the main window. This will open the 'recipes explorer' window.
...
### Titles explorer
Click on the 'title' icon in the toolbar of the main window. This will open the 'titles explorer' window.
...
### Emotes explorer
Click on the 'emote' icon in the toolbar of the main window. This will open the 'emotes explorer' window.
...
### Mounts
Click on the 'mount' icon in the toolbar of the main window. This will open the 'mounts explorer' window.
...
### Cosmetic pets
Click on the 'pet' icon in the toolbar of the main window. This will open the 'cosmetic pets explorer' window.
...
### Vendors
Click on the 'green flag' icon in the toolbar of the main window. This will open the 'vendors explorer' window.
...
### Barterers
Click on the 'blue flag' icon in the toolbar of the main window. This will open the 'barterers explorer' window.
...
### Maps
Click on the 'globe' icon in the toolbar of the main window. This will open the 'maps explorer' window.
This window will let you browse through the maps.
The top part contains:
- a map selector
- a categories filter
Click on the 'Barad Dur' icon in the toolbar of the main window. This will open the 'instances explorer' window.
Click on the 'Resource' icon in the toolbar of the main window. This will open the 'resources maps explorer' window.
